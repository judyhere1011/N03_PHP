...
class ShoppingCartPage
{
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding" style="margin-top: 15px;">
                ...
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 clearpaddingr">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
                        ...
                        <?php $this->displayCartPanel($totalItems, $carts); ?>
    ...
    private function displayCartPanel($totalItems, $carts)
    {
        if ($totalItems > 0) {
            ?>
            <div class="panel panel-info " style="margin-top: 20px;margin-bottom: 15px;background-color: #ffffff">
                <div class="panel-heading">
                    <h3 class="panel-title">GIỎ HÀNG ( <?php echo $totalItems; ?> sản phẩm )</h3>
                </div>
...
// Truyền biến $db khi tạo đối tượng ShoppingCartPage
$shoppingCartPage = new ShoppingCartPage($db);
$shoppingCartPage->displayCartPage();
?>
